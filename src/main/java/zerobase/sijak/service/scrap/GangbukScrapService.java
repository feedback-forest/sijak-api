...
@Transactional
public class GangbukScrapService {
    ...
    public void scrapGangbuk() throws CustomException {
        try {
            ...
            String GANGBUK_URL = "https://50plus.or.kr/gbc/education.do?page=%d&";
            int idx = 1;
            while (true) {
                String url = String.format(GANGBUK_URL, idx);
                        ...
                        switch (j) {
                            ...
                            case 9:
                                ...
                                Lecture lecture = Lecture.builder()
                                        ...
                                        .status(true)
                                        .latitude(37.618815)
                                        .longitude(127.033254)
                                        .centerName("서울시 50+강북50플러스센터")
                                        .address("서울특별시 강북구 오현로9길 49")
                                        .build();
