...
@Transactional
public class YeongdeungpoScrapService {
    ...
    public void scrapYeongdeungpo() throws CustomException {
        try {
            ...
            String YEONGDEUNGPO_URL = "https://50plus.or.kr/ydp/education.do?page=%d&";
            int idx = 1;
            while (true) {
                String url = String.format(YEONGDEUNGPO_URL, idx);
                        ...
                        switch (j) {
                            ...
                            case 9:
                                ...
                                Lecture lecture = Lecture.builder()
                                        ...
                                        .status(true)
                                        .latitude(37.518197)
                                        .longitude(126.930757)
                                        .centerName("서울시 50+여의도50플러스센터")
                                        .address("서울특별시 영등포구 여의대방로 372(여의도동 56-1) 여의도복지관 3층")
                                        .build();
    ...
    public void getDetailInfo(int lId, String href) throws CustomException {
        try {
            ...
            List<WebElement> campus_course_table_list = driver.findElements(By.className("campus-course-list-table"));
            log.info("campus_lst: {}", campus_course_table_list.size());

            WebElement we;
            if (campus_course_table_list.size() == 1)
                we = driver
                        .findElement(By.cssSelector("body > div.container > div.course-content.clearfix > div.course-left > div.course-schedule-table > div > table > tbody > tr:nth-child(1)"));
            else
                we = driver
                        .findElement(By.cssSelector("body > div.container > div.course-content.clearfix > div.course-left > div:nth-child(3) > div > table > tbody > tr:nth-child(1)"));
            List<WebElement> tds = we.findElements(By.tagName("td"));
            log.info("we pass");
            log.info("td[0]: {}", tds.get(0).getText());
            ...
            List<WebElement> trs;
            if (campus_course_table_list.size() == 1)
                trs = driver.findElements(By.cssSelector("body > div.container > div.course-content.clearfix > div.course-left > div.course-schedule-table > div > table > tbody > tr"));
            else
                trs = driver.findElements(By.cssSelector("body > div.container > div.course-content.clearfix > div.course-left > div:nth-child(3) > div > table > tbody > tr"));
