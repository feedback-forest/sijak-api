...
@Transactional
public class SeongbukScrapService {
    ...
    public void scrapSeodaemun() throws CustomException {
        try {
            ...
            String SEONGBUK_URL = "https://50plus.or.kr/sbc/education.do?page=%d&";
            int idx = 1;
            while (true) {
                String url = String.format(SEONGBUK_URL, idx);
                        ...
                        switch (j) {
                            ...
                            case 9:
                                ...
                                Lecture lecture = Lecture.builder()
                                        ...
                                        .status(true)
                                        .latitude(37.583936)
                                        .longitude(127.019291)
                                        .centerName("서울시 50+성북50플러스센터")
                                        .address("서울시 성북구 지봉로 24길 26 (보문동 5가 35번지) 3-4층 (보문역 7번 출구)")
                                        .build();
