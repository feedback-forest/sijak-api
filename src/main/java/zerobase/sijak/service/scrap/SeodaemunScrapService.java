...
@Transactional
public class SeodaemunScrapService {
    ...
    public void scrapSeodaemun() throws CustomException {
        try {
            ...
            String SEODAEMUN_URL = "https://50plus.or.kr/sdm/education.do?page=%d&";
            int idx = 1;
            while (true) {
                String url = String.format(SEODAEMUN_URL, idx);
                        ...
                        switch (j) {
                            ...
                            case 9:
                                ...
                                Lecture lecture = Lecture.builder()
                                        ...
                                        .status(true)
                                        .latitude(37.591527)
                                        .longitude(126.942971)
                                        .centerName("서울시 50+서대문50플러스센터")
                                        .address("서울특별시 서대문구 통일로 484 공유캠퍼스(유진상가) 2층")
                                        .build();
