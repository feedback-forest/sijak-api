...
@Transactional
public class GangdongScrapService {
    ...
    public void scrapGangdong() throws CustomException {
        try {
            ...
            String GANGDONG_URL = "https://50plus.or.kr/gdc/education.do?page=%d&";
            int idx = 1;
            while (true) {
                String url = String.format(GANGDONG_URL, idx);
                        ...
                        switch (j) {
                            ...
                            case 9:
                                ...
                                Lecture lecture = Lecture.builder()
                                        ...
                                        .status(true)
                                        .latitude(37.548231)
                                        .longitude(127.127155)
                                        .centerName("서울시 50+강동50플러스센터")
                                        .address("서울특별시 강동구 올림픽로 752 (천호동)")
                                        .build();
